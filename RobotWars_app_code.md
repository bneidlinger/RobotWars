...
<body>
    ...
    <script src="js/engine/interpreter.js"></script> <!-- Note: This is client-side, likely unused now -->
    <script src="js/engine/collision.js"></script>   <!-- Note: This is client-side, likely unused now -->
